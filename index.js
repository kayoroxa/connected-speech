let myDict = [
  ...
  ['\\bThe a', 'Thi-a'],
  ['\\bface\\b', 'feiss'],
  ['(w)me? (a|e|i|o|u|á|é|í|ó|ú)', '$1-M$2'],
  ['ve i', 'vi', false],
  ...
  ['he i', 'hei'],
  ['re o', 'ro'],
  ['z (a|e|i|o|u|á|é|í|ó|ú)', '-z$1'],
  ['ce (a|i|o|u|á|í|ó|ú)', '-ç$1'],
  ['n (a|e|i|o|u|á|é|í|ó|ú|y)', '-n$1'],
  ['s (a|e|i|o|u|á|é|í|ó|ú)', '-z$1'],
  ['d (a|e|i|o|u|á|é|í|ó|ú)', '-r$1'],
  ['v (a|e|i|o|u|á|é|í|ó|ú|y)', '-v$1'],
  ['(k|p|f) (a|e|i|o|u|á|é|í|ó|ú|y)', '-$1$2'],
  ['n m', '.m'],
  ['if we', 'ife', false],
  ['on râ', 'on to'],
  ['(?<!h)e e', 'e'],
